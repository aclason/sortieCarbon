...
#'
#' @examples
calcSortieC <- function(sortie_outputs, dead = FALSE, BEC, Ht_from_diam = TRUE){

  sort_out <- readSortie(outputs = sortie_outputs)
...
#'
#' @examples
cwdCfromSORTIE <- function(volGrid, spGroups){
